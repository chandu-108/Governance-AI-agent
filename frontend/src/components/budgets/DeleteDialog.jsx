...
const DeleteDialog = ({ open, onClose, onConfirm, budget, isLoading, agents }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="p-6">
              ...
              <h2 className="text-base font-semibold text-gray-900 text-center mb-1">Remove Budget</h2>
              <p className="text-sm text-gray-500 text-center mb-6 leading-relaxed">
                Are you sure you want to remove the budget for{' '}
                <span className="font-semibold text-gray-700">"{agentName}"</span>? This will lift all spending limits on this agent.
              </p>
